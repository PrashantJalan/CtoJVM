...
def p_postfix_expression_7(t):
	...
	t[0]=Node('postfix_expression', [t[0],Node(t[1],'')])
def p_postfix_expression_8(t):
	'postfix_expression : postfix_expression DEC_OP'
	t[0]=Node('postfix_expression', [t[0],Node(t[1],'')])
def p_argument_expression_list_1(t):
	'argument_expression_list : assignment_expression'
	t[0]=Node('argument_expression_list', [t[0]])
def p_argument_expression_list_2(t):
	'argument_expression_list : argument_expression_list COMMA assignment_expression'
	t[0]=Node('argument_expression_list', [t[0],Node(t[1],''),t[2]])
def p_unary_expression_1(t):
	'unary_expression : postfix_expression'
	t[0]=Node('unary_expression', [t[0]])
def p_unary_expression_2(t):
	'unary_expression : INC_OP unary_expression'
	t[0]=Node('unary_expression', [Node(t[0],''),t[1]])
def p_unary_expression_3(t):
	'unary_expression : DEC_OP unary_expression'
	t[0]=Node('unary_expression', [Node(t[0],''),t[1]])
def p_unary_expression_4(t):
	'unary_expression : unary_operator cast_expression'
	t[0]=Node('unary_expression', [t[0],t[1]])
def p_unary_expression_5(t):
	'unary_expression : SIZEOF unary_expression'
	t[0]=Node('unary_expression', [t[0],t[1]])
def p_unary_expression_6(t):
	'unary_expression : SIZEOF LEFT_ROUND type_name RIGHT_ROUND'
	t[0]=Node('unary_expression', [t[0],Node(t[1],''),t[2],Node(t[3],'')])
def p_unary_operator_1(t):
	'unary_operator : AMPERSAND'
	t[0]=Node('unary_operator', [Node(t[0],'')])
...
def p_cast_expression_1(t):
	...
	t[0]=Node('cast_expression', [t[0]])
def p_cast_expression_2(t):
	'cast_expression : LEFT_ROUND type_name RIGHT_ROUND cast_expression'
	t[0]=Node('cast_expression', [Node(t[0],''),t[1],Node(t[2],''),t[3]])
def p_multiplicative_expression_1(t):
	'multiplicative_expression : cast_expression'
	t[0]=Node('multiplicative_expression', [t[0]])
def p_multiplicative_expression_2(t):
	'multiplicative_expression : multiplicative_expression MULTIPLY cast_expression'
	t[0]=Node('multiplicative_expression', [t[0],Node(t[1],''),t[2]])
...
def p_additive_expression_1(t):
	...
	t[0]=Node('additive_expression', [t[0]])
def p_additive_expression_2(t):
	'additive_expression : additive_expression PLUS multiplicative_expression'
	t[0]=Node('additive_expression', [t[0],Node(t[1],''),t[2]])
def p_additive_expression_3(t):
	'additive_expression : additive_expression MINUS multiplicative_expression'
	t[0]=Node('additive_expression', [t[0],Node(t[1],''),t[2]])
def p_shift_expression_1(t):
	'shift_expression : additive_expression'
	t[0]=Node('shift_expression', [t[0]])
def p_shift_expression_2(t):
	'shift_expression : shift_expression LEFT_OP additive_expression'
	t[0]=Node('shift_expression', [t[0],Node(t[1],''),t[2]])
def p_shift_expression_3(t):
	'shift_expression : shift_expression RIGHT_OP additive_expression'
	t[0]=Node('shift_expression', [t[0],Node(t[1],''),t[2]])
def p_relational_expression_1(t):
	'relational_expression : shift_expression'
	t[0]=Node('relational_expression', [t[0]])
def p_relational_expression_2(t):
	'relational_expression : relational_expression L_OP shift_expression'
	t[0]=Node('relational_expression', [t[0],Node(t[1],''),t[2]])
...
def p_equality_expression_1(t):
	...
	t[0]=Node('equality_expression', [t[0]])
def p_equality_expression_2(t):
	'equality_expression : equality_expression EQ_OP relational_expression'
	t[0]=Node('equality_expression', [t[0],Node(t[1],''),t[2]])
def p_equality_expression_3(t):
	'equality_expression : equality_expression NE_OP relational_expression'
	t[0]=Node('equality_expression', [t[0],Node(t[1],''),t[2]])
def p_and_expression_1(t):
	'and_expression : equality_expression'
	t[0]=Node('and_expression', [t[0]])
def p_and_expression_2(t):
	'and_expression : and_expression AMPERSAND equality_expression'
	t[0]=Node('and_expression', [t[0],Node(t[1],''),t[2]])
def p_exclusive_or_expression_1(t):
	'exclusive_or_expression : and_expression'
	t[0]=Node('exclusive_or_expression', [t[0]])
def p_exclusive_or_expression_2(t):
	'exclusive_or_expression : exclusive_or_expression POWER and_expression'
	t[0]=Node('exclusive_or_expression', [t[0],Node(t[1],''),t[2]])
def p_inclusive_or_expression_1(t):
	'inclusive_or_expression : exclusive_or_expression'
	t[0]=Node('inclusive_or_expression', [t[0]])
def p_inclusive_or_expression_2(t):
	'inclusive_or_expression : inclusive_or_expression PIPE exclusive_or_expression'
	t[0]=Node('inclusive_or_expression', [t[0],Node(t[1],''),t[2]])
def p_logical_and_expression_1(t):
	'logical_and_expression : inclusive_or_expression'
	t[0]=Node('logical_and_expression', [t[0]])
def p_logical_and_expression_2(t):
	'logical_and_expression : logical_and_expression AND_OP inclusive_or_expression'
	t[0]=Node('logical_and_expression', [t[0],Node(t[1],''),t[2]])
def p_logical_or_expression_1(t):
	'logical_or_expression : logical_and_expression'
	t[0]=Node('logical_or_expression', [t[0]])
def p_logical_or_expression_2(t):
	'logical_or_expression : logical_or_expression OR_OP logical_and_expression'
	t[0]=Node('logical_or_expression', [t[0],Node(t[1],''),t[2]])
def p_conditional_expression_1(t):
	'conditional_expression : logical_or_expression'
	t[0]=Node('conditional_expression', [t[0]])
def p_conditional_expression_2(t):
	'conditional_expression : logical_or_expression QUESTION expression COLON conditional_expression'
	t[0]=Node('conditional_expression', [t[0],Node(t[1],''),t[2],Node(t[3],''),t[4]])
def p_assignment_expression_1(t):
	'assignment_expression : conditional_expression'
	t[0]=Node('assignment_expression', [t[0]])
def p_assignment_expression_2(t):
	'assignment_expression : unary_expression assignment_operator assignment_expression'
	t[0]=Node('assignment_expression', [t[0],t[1],t[2]])
def p_assignment_operator_1(t):
	'assignment_operator : EQUAL'
	t[0]=Node('assignment_operator', [Node(t[0],'')])
...
def p_expression_1(t):
	...
	t[0]=Node('expression', [t[0]])
def p_expression_2(t):
	'expression : expression COMMA assignment_expression'
	t[0]=Node('expression', [t[0],Node(t[1],''),t[2]])
def p_constant_expression_1(t):
	'constant_expression : conditional_expression'
	t[0]=Node('constant_expression', [t[0]])
def p_declaration_1(t):
	'declaration : declaration_specifiers SEMICOLON'
	t[0]=Node('declaration', [t[0],Node(t[1],'')])
def p_declaration_2(t):
	'declaration : declaration_specifiers init_declarator_list SEMICOLON'
	t[0]=Node('declaration', [t[0],t[1],Node(t[2],'')])
def p_declaration_specifiers_1(t):
	'declaration_specifiers : storage_class_specifier'
	t[0]=Node('declaration_specifiers', [t[0]])
def p_declaration_specifiers_2(t):
	'declaration_specifiers : storage_class_specifier declaration_specifiers'
	t[0]=Node('declaration_specifiers', [t[0],t[1]])
...
def p_init_declarator_list_1(t):
	...
	t[0]=Node('init_declarator_list', [t[0]])
def p_init_declarator_list_2(t):
	'init_declarator_list : init_declarator_list COMMA init_declarator'
	t[0]=Node('init_declarator_list', [t[0],Node(t[1],''),t[2]])
def p_init_declarator_1(t):
	'init_declarator : declarator'
	t[0]=Node('init_declarator', [t[0]])
def p_init_declarator_2(t):
	'init_declarator : declarator EQUAL initializer'
	t[0]=Node('init_declarator', [t[0],Node(t[1],''),t[2]])
def p_storage_class_specifier_1(t):
	'storage_class_specifier : TYPEDEF'
	t[0]=Node('storage_class_specifier', [Node(t[0],'')])
...
def p_type_specifier_1(t):
	'type_specifier : VOID'
	t[0]=Node('type_specifier', [Node(t[0],'')])
...
def p_struct_or_union_specifier_1(t):
	...
	t[0]=Node('struct_or_union_specifier', [t[0],Node(t[1],''),Node(t[2],''),t[3],Node(t[4],'')])
def p_struct_or_union_specifier_2(t):
	...
	t[0]=Node('struct_or_union_specifier', [t[0],Node(t[1],''),t[2],Node(t[3],'')])
def p_struct_or_union_specifier_3(t):
	'struct_or_union_specifier : struct_or_union IDENTIFIER'
	t[0]=Node('struct_or_union_specifier', [t[0],Node(t[1],'')])
def p_struct_or_union_1(t):
	'struct_or_union : STRUCT'
	t[0]=Node('struct_or_union', [Node(t[0],'')])
def p_struct_or_union_2(t):
	'struct_or_union : UNION'
	t[0]=Node('struct_or_union', [Node(t[0],'')])
def p_struct_declaration_list_1(t):
	'struct_declaration_list : struct_declaration'
	t[0]=Node('struct_declaration_list', [t[0]])
def p_struct_declaration_list_2(t):
	'struct_declaration_list : struct_declaration_list struct_declaration'
	t[0]=Node('struct_declaration_list', [t[0],t[1]])
def p_struct_declaration_1(t):
	'struct_declaration : specifier_qualifier_list struct_declarator_list SEMICOLON'
	t[0]=Node('struct_declaration', [t[0],t[1],Node(t[2],'')])
def p_specifier_qualifier_list_1(t):
	'specifier_qualifier_list : type_specifier specifier_qualifier_list'
	t[0]=Node('specifier_qualifier_list', [t[0],t[1]])
def p_specifier_qualifier_list_2(t):
	'specifier_qualifier_list : type_specifier'
	t[0]=Node('specifier_qualifier_list', [t[0]])
...
def p_pointer_1(t):
	'pointer : MULTIPLY'
	t[0]=Node('pointer', [Node(t[0],'')])
def p_pointer_2(t):
	'pointer : MULTIPLY type_qualifier_list'
	t[0]=Node('pointer', [Node(t[0],''),t[1]])
def p_pointer_3(t):
	'pointer : MULTIPLY pointer'
	t[0]=Node('pointer', [Node(t[0],''),t[1]])
def p_pointer_4(t):
	'pointer : MULTIPLY type_qualifier_list pointer'
	t[0]=Node('pointer', [Node(t[0],''),t[1],t[2]])
def p_type_qualifier_list_1(t):
	'type_qualifier_list : type_qualifier'
	t[0]=Node('type_qualifier_list', [t[0]])
def p_type_qualifier_list_2(t):
	'type_qualifier_list : type_qualifier_list type_qualifier'
	t[0]=Node('type_qualifier_list', [t[0],t[1]])
def p_parameter_type_list1(t):
	'parameter_type_list : parameter_list'
	t[0]=Node('', [t[0]])
def p_parameter_type_list2(t):
	'parameter_type_list : parameter_list COMMA ELLIPSIS'
	t[0]=Node('', [t[0]])
def p_parameter_list_1(t):
	'parameter_list : parameter_declaration'
	t[0]=Node('parameter_list', [t[0]])
def p_parameter_list_2(t):
	'parameter_list : parameter_list COMMA parameter_declaration'
	t[0]=Node('parameter_list', [t[0],Node(t[1],''),t[2]])
def p_parameter_declaration_1(t):
	'parameter_declaration : declaration_specifiers declarator'
	t[0]=Node('parameter_declaration', [t[0],t[1]])
def p_parameter_declaration_2(t):
	'parameter_declaration : declaration_specifiers abstract_declarator'
	t[0]=Node('parameter_declaration', [t[0],t[1]])
def p_parameter_declaration_3(t):
	'parameter_declaration : declaration_specifiers'
	t[0]=Node('parameter_declaration', [t[0]])
def p_identifier_list_1(t):
	'identifier_list : IDENTIFIER'
	t[0]=Node('identifier_list', [Node(t[0],'')])
def p_identifier_list_2(t):
	'identifier_list : identifier_list COMMA IDENTIFIER'
	t[0]=Node('identifier_list', [t[0],Node(t[1],''),Node(t[2],'')])
def p_type_name_1(t):
	'type_name : specifier_qualifier_list'
	t[0]=Node('type_name', [t[0]])
def p_type_name_2(t):
	'type_name : specifier_qualifier_list abstract_declarator'
	t[0]=Node('type_name', [t[0],t[1]])
def p_abstract_declarator_1(t):
	'abstract_declarator : pointer'
	t[0]=Node('abstract_declarator', [t[0]])
def p_abstract_declarator_2(t):
	'abstract_declarator : direct_abstract_declarator'
	t[0]=Node('abstract_declarator', [t[0]])
def p_abstract_declarator_3(t):
	'abstract_declarator : pointer direct_abstract_declarator'
	t[0]=Node('abstract_declarator', [t[0],t[1]])
def p_direct_abstract_declarator_1(t):
	'direct_abstract_declarator : LEFT_ROUND abstract_declarator RIGHT_ROUND'
	t[0]=Node('direct_abstract_declarator', [Node(t[0],''),t[1],Node(t[2],'')])
def p_direct_abstract_declarator_2(t):
	'direct_abstract_declarator : LEFT_SQUARE RIGHT_SQUARE'
	t[0]=Node('direct_abstract_declarator', [Node(t[0],''),Node(t[1],'')])
...
def p_direct_abstract_declarator_4(t):
	...
	t[0]=Node('direct_abstract_declarator', [t[0],Node(t[1],''),Node(t[2],'')])
def p_direct_abstract_declarator_5(t):
	...
	t[0]=Node('direct_abstract_declarator', [t[0],Node(t[1],''),t[2],Node(t[3],'')])
...
def p_initializer_1(t):
	...
	t[0]=Node('initializer', [t[0]])
def p_initializer_2(t):
	'initializer : LEFT_CURL initializer_list RIGHT_CURL'
	t[0]=Node('initializer', [Node(t[0],''),t[1],Node(t[2],'')])
def p_initializer_3(t):
	'initializer : LEFT_CURL initializer_list COMMA RIGHT_CURL'
	t[0]=Node('initializer', [Node(t[0],''),t[1],Node(t[2],''),Node(t[3],'')])
def p_initializer_list_1(t):
	'initializer_list : initializer'
	t[0]=Node('initializer_list', [t[0]])
def p_initializer_list_2(t):
	'initializer_list : initializer_list COMMA initializer'
	t[0]=Node('initializer_list', [t[0],Node(t[1],''),t[2]])
def p_statement_1(t):
	'statement : labeled_statement'
	t[0]=Node('statement', [t[0]])
def p_statement_2(t):
...
def p_labeled_statement_1(t):
	...
	t[0]=Node('labeled_statement', [Node(t[0],''),Node(t[1],''),t[2]])
def p_labeled_statement_2(t):
	'labeled_statement : CASE constant_expression COLON statement'
	t[0]=Node('labeled_statement', [Node(t[0],''),t[1],Node(t[2],''),t[3]])
def p_labeled_statement_3(t):
	'labeled_statement : DEFAULT COLON statement'
	t[0]=Node('labeled_statement', [Node(t[0],''),Node(t[1],''),t[2]])
def p_compound_statement_1(t):
	'compound_statement : LEFT_CURL RIGHT_CURL'
	t[0]=Node('compound_statement', [Node(t[0],''),Node(t[1],'')])
def p_compound_statement_2(t):
	'compound_statement : LEFT_CURL statement_list RIGHT_CURL'
	t[0]=Node('compound_statement', [Node(t[0],''),t[1],Node(t[2],'')])
...
def p_compound_statement_4(t):
	...
	t[0]=Node('compound_statement', [Node(t[0],''),t[1],t[2],Node(t[3],'')])
def p_declaration_list_1(t):
	'declaration_list : declaration'
	t[0]=Node('declaration_list', [t[0]])
def p_declaration_list_2(t):
	'declaration_list : declaration_list declaration'
	t[0]=Node('declaration_list', [t[0],t[1]])
def p_statement_list_1(t):
	'statement_list : statement'
	t[0]=Node('statement_list', [t[0]])
def p_statement_list_2(t):
	'statement_list : statement_list statement'
	t[0]=Node('statement_list', [t[0],t[1]])
def p_expression_statement_1(t):
	'expression_statement : SEMICOLON'
	t[0]=Node('expression_statement', [Node(t[0],'')])
...
def p_selection_statement_2(t):
	...
	t[0]=Node('selection_statement', [Node(t[0],''),Node(t[1],''),t[2],Node(t[3],''),t[4],Node(t[5],''),t[6]])
...
def p_iteration_statement_1(t):
	...
	t[0]=Node('iteration_statement', [Node(t[0],''),Node(t[1],''),t[2],Node(t[3],''),t[4]])
def p_iteration_statement_2(t):
	'iteration_statement : DO statement WHILE LEFT_ROUND expression RIGHT_ROUND SEMICOLON'
	t[0]=Node('iteration_statement', [Node(t[0],''),t[1],Node(t[2],''),Node(t[3],''),t[4],Node(t[5],''),Node(t[6],'')])
def p_iteration_statement_3(t):
	'iteration_statement : FOR LEFT_ROUND expression_statement expression_statement RIGHT_ROUND statement'
	t[0]=Node('iteration_statement', [Node(t[0],''),Node(t[1],''),t[2],t[3],Node(t[4],''),t[5]])
def p_iteration_statement_4(t):
	...
	t[0]=Node('iteration_statement', [Node(t[0],''),Node(t[1],''),t[2],t[3],t[4],Node(t[5],''),t[6]])
def p_jump_statement_1(t):
	'jump_statement : GOTO IDENTIFIER SEMICOLON'
	t[0]=Node('jump_statement', [Node(t[0],''),Node(t[1],''),Node(t[2],'')])
def p_jump_statement_2(t):
	'jump_statement : CONTINUE SEMICOLON'
	t[0]=Node('jump_statement', [Node(t[0],''),Node(t[1],'')])
...
def p_function_definition_1(t):
	...
	t[0]=Node('function_definition', [t[0],t[1],t[2],t[3]])
def p_function_definition_2(t):
	'function_definition : declaration_specifiers declarator compound_statement'
	t[0]=Node('function_definition', [t[0],t[1],t[2]])
def p_function_definition_3(t):
	'function_definition : declarator declaration_list compound_statement'
	t[0]=Node('function_definition', [t[0],t[1],t[2]])
def p_function_definition_4(t):
	'function_definition : declarator compound_statement'
	t[0]=Node('function_definition', [t[0],t[1]])
